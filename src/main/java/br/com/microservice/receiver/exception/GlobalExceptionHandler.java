...
//    @ExceptionHandler(ReceiverError.EstoqueProdutoNotFoundException.class)
//    @ResponseStatus(HttpStatus.NOT_FOUND)
//    public ResponseEntity<Object> handleEstoqueProdutoNotFound(ReceiverError.EstoqueProdutoNotFoundException ex, WebRequest request) {
...
//    @ExceptionHandler(ReceiverError.EstoqueProdutoAlreadyExistsException.class)
//    @ResponseStatus(HttpStatus.CONFLICT)
//    public ResponseEntity<Object> handleEstoqueProdutoAlreadyExists(ReceiverError.EstoqueProdutoAlreadyExistsException ex, WebRequest request) {
//        return ResponseEntity
